<?php 
$_GET['menu'] = 'workouts';
$_GET['submenu'] = 'Calisthenics/Streetworkout';
$_GET['title'] = 'Calisthenics/Streetworkout';
include('../../config.php');
include('../../head.php');
?>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Calisthenics/Streetworkout</h1>
								</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
                            	<div class="service-txt">
									...
									<p class="service-txt">
										<img style="width:500px;margin:auto" src="<?php echo $pageUrl; ?>images/Street_workout_Calistheics_e.jpg" alt="Street_workout_Calistheics_e.jpg" class="img-responsive">
									</p>
                                </div>
							</div>
